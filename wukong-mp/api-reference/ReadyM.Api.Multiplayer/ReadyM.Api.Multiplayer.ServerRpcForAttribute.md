...
public sealed class ServerRpcForAttribute : Attribute
```
...
### <a id="ReadyM_Api_Multiplayer_ServerRpcForAttribute__ctor_System_Type_"></a> ServerRpcForAttribute\(Type\)
...
```csharp
public ServerRpcForAttribute(Type contractsType)
```

#### Parameters

`contractsType` [Type](https://learn.microsoft.com/dotnet/api/system.type)

## Properties

### <a id="ReadyM_Api_Multiplayer_ServerRpcForAttribute_ContractsType"></a> ContractsType

The <code>[ServerRpcContracts]</code> class this RPC class implements.

```csharp
public Type ContractsType { get; }
```
