...
- Binary package
- [Docker image](#docker) (coming soon)
...
A Linux-based x64 Docker image is on the way for those who prefer containerized deployments. It is not published yet. For now, use the binary package above.
