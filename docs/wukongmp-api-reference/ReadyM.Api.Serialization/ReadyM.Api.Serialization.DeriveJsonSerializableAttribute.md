...
### <a id="ReadyM_Api_Serialization_DeriveJsonSerializableAttribute__ctor_ReadyM_Api_Serialization_SerializableMode_"></a> DeriveJsonSerializableAttribute\(SerializableMode\)

```csharp
public DeriveJsonSerializableAttribute(SerializableMode mode = SerializableMode.Default)
```
...
### <a id="ReadyM_Api_Serialization_DeriveJsonSerializableAttribute_Mode"></a> Mode
