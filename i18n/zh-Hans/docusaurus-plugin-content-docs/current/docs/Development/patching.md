...
属性进行标记，并使用
[PatchCategory](../../api-reference/WukongMp.Api.Configuration/WukongMp.Api.Configuration.PatchCategory)
中定义的常量之一，如下所示：
...
[HarmonyTargetMethodHint](../../api-reference/PreludeLib.Attributes/PreludeLib.Attributes.HarmonyTargetMethodHint)
