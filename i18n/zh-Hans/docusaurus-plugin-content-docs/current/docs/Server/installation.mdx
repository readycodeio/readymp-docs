...
| 平台      | 架构  | 下载                                                                                                              |
| ------- | --- | --------------------------------------------------------------------------------------------------------------- |
| Linux   | x64 | [Linux 版下载](https://readymstorage.blob.core.windows.net/wukong-server-releases/wukong-server-linux64-0.2.1.zip) |
| Windows | x64 | [Windows 版下载](https://readymstorage.blob.core.windows.net/wukong-server-releases/wukong-server-win64-0.2.1.zip) |
