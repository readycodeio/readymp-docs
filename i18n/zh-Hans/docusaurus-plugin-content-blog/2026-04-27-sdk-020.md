...
- 两种新的（临时的）API —— [PvP
  API](/wukong-mp/0.2.4/api-reference/WukongMp.Sdk.Api/WukongMp.Sdk.Api.IWukongPvpApi)
  和 [Cheats
  API](/wukong-mp/0.2.4/api-reference/WukongMp.Sdk.Api/WukongMp.Sdk.Api.IWukongCheatsApi)，在服务器端脚本就绪之前，用于实现自托管的
