...
- **Server binary downloads are still rolling out.** The Windows and Linux packages and the Docker image are coming soon; SDK access is currently invite-only.
...
If you hit a bug, have a mod idea, or want to tell us what is missing, come find us on the [OblivionMP Discord](https://discord.gg/obmp). To get started, read [What is OblivionMP?](/oblivion-mp/docs/what-is-oblivion-mp) and the [installation guide](/oblivion-mp/docs/Server/installation).
