...
If you hit a bug, have a mod idea, or want to tell us what is missing, come find us on the [OblivionMP Discord](https://discord.gg/obmp). To get started, read [What is OblivionMP?](/oblivion-mp/docs/what-is-oblivion-mp), grab the server from the [installation guide](/oblivion-mp/docs/Server/installation), and clone the [mod template](https://github.com/readycodeio/oblivionmp-mod-template) to build your first mod.
