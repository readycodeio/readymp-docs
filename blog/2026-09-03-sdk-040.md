...
`0.4.0` moves a lot of mod code off the client and onto the server. Nearly everything below follows from that.

Mod authors: this release has real breaking changes. Read [Upgrading](#upgrading) before you rebuild.
