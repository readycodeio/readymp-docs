...
In the WukongMP SDK's Harmony fork this method requires the [HarmonyTargetMethodHint](../../api-reference/PreludeLib.Attributes/PreludeLib.Attributes.HarmonyTargetMethodHint) attribute to be present. The first argument is the fully qualified class name. The second argument is the patched member name.
