...
```csharp
public struct EffectsAttributesComponent : ISaveTaggedComponent<EffectsAttributesComponent>, INativeInit, IComponent, INetSerializable, IDisposable
```
...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_EffectsAttributesComponent_AttributeNotifyChanged_System_Int32_"></a> AttributeNotifyChanged\(int\)
...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_EffectsAttributesComponent_Attribute_SetFromApi_Yooni_Native_Container_NativeDictionary_System_Byte_System_Single_Yooni_Native_Container_ByteHash__System_Int32_"></a> Attribute\_SetFromApi\(NativeDictionary<byte, float, ByteHash\>, int\)
...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_EffectsAttributesComponent_GetChangeComponent"></a> GetChangeComponent\(\)
...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_EffectsAttributesComponent_Init_Yooni_Native_LowLevel_AllocatorKind_"></a> Init\(AllocatorKind\)
