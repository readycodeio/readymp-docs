...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_NicknameComponent_GetChangeComponent"></a> GetChangeComponent\(\)
...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_NicknameComponent_NicknameNotifyChanged_System_Int32_"></a> NicknameNotifyChanged\(int\)
