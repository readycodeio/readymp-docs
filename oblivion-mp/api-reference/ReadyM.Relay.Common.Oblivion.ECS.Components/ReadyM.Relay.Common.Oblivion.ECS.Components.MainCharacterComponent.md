...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_MainCharacterComponent_GetChangeComponent"></a> GetChangeComponent\(\)
...
### <a id="ReadyM_Relay_Common_Oblivion_ECS_Components_MainCharacterComponent_PlayerIdNotifyChanged_System_Int32_"></a> PlayerIdNotifyChanged\(int\)
